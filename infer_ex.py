...
#"a painting of t@t illustration style"
if __name__ == "__main__":
    os.makedirs(args.output_dir, exist_ok=True)

    # define prompts
    prompts = [
        "a photo of t@t person",
        "a dslr portrait of t@t person",
        "a photo of t@t person looking at the mirror",
        "a photo of t@t person in front of eiffel tower",
    ]
    # create & load model
